...
class JokeBot:
    ...
    def rate_the_joke(self, joke: str) -> int:
        """
    ...
    def generate_joke(self):
        ...
        This joke bot and tell 3 types of jokes:
        1. Christmas joke
        2. Programming joke
        3. Jokes from rjokes dataset (contains jokes from reddit channel rjokes)

        Joke types 1 and 2 are generated using the JokeAPI

        Joke type 3 is generated by fine-tuning a gpt-2 model on rjokes dataset. Rjokes dataset contain
        The full dataset was not used fine-tuning.
        Only jokes that are non-toxic and with length below 50 are considered.
    ...
    def user_interaction(self):
        ...
        while True:
            ...
            print(f'Rater model rated the joke as: ', self.rate_the_joke(joke))

            user_input = input('Do you want to hear more jokes? (y/n)')
            if user_input == 'n':
                break
